...
public class EachMealController {
  ...
  public ResponseEntity deleteEachMeal(@PathVariable("eachmealid") long eachmealid) {
  ...
  public ResponseEntity clearEachMealFood(@PathVariable("eachmealid") long eachmealid) {
